INSERT INTO payments.users (user_name, user_password, user_type)
VALUES ('payments', '$2a$12$M.PX8izRwZO7le6n168LYO2BTp8FItI5z6WVYSBsBKiggidBBSokq', 'LEGAL'),
       ('java', '$2a$12$f1a2Q3XvCmJsW0DM/wnh8eqzmlnZuG2r0VdcI.KDflY4y6r.ea0dy', 'LEGAL'),
       ('spring', '$2a$12$e88yr1u0pYJEsarbqZllt.A7vdglk8ePwidM5l0tQHH76OkALCW6i', 'LEGAL'),
       ('admin', '$2a$10$wn/OIrmp1YV.2LOaExEw/.cYugHc0Dm7VHyOgng4rIp9Q045mKHMS', 'INDIVIDUAL'),
       ('user', '$2a$12$EysLwygGcI32VdaPwphx0enC4xD5kQb603ohTDYMcj/P8zs6TxfoO', 'INDIVIDUAL');


INSERT INTO payments.roles (user_role, user_user_id)
VALUES ('ROLE_ADMIN', 1),
       ('ROLE_CUSTOMER', 2),
       ('ROLE_CUSTOMER', 3),
       ('ROLE_ADMIN', 4),
...
INSERT INTO payments.cards (card_number, card_expiration_date, card_cvv, card_status, accounts_account_id)
VALUES ('Card2522358261698812', '2027-10-03', 502, 'LOCKED', 1),
       ...
       ('Card5383247252190595', '2027-10-03', 888, 'ACTIVE', 7),
